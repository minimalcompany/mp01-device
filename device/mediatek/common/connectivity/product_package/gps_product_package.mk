...
ifeq ($(strip $(MTK_GPS_SUPPORT)), yes)
  ...
  ifeq ($(strip $(MTK_AGPS_APP)), yes)
    ...
    PRODUCT_COPY_FILES += device/mediatek/common/agps/$(MTK_AGPS_CONF_XML_SRC):$(TARGET_COPY_OUT_VENDOR)/etc/gnss/agps_profiles_conf2.xml:mtk

    # agps configuration for carriers
    PRODUCT_COPY_FILES += $(call find-copy-subdir-files,*,device/mediatek/common/agps/carrier,$(TARGET_COPY_OUT_VENDOR)/etc/gnss/carrier)
