...
WLAN_GEN4M_CHIPS := CONSYS_6765 CONSYS_6761 CONSYS_3967 CONSYS_6779 CONSYS_6768 CONSYS_6785 CONSYS_6885 CONSYS_6873 CONSYS_8168 CONSYS_6853 CONSYS_6893 CONSYS_6833 CONSYS_6877
...
ifeq ($(strip $(MTK_COMBO_CHIP)), MT6632)
    ...
    ifneq ($(strip $(WLAN_CHIP_ID)),)
        ...
        WLAN_CONNAC_SERIES := $(WLAN_6765_SERIES) 3967 6779 6768 6785 6885 6873 8168 6853 6893 6833 6877
        ifneq ($(filter $(WLAN_6755_SERIES), $(WLAN_CHIP_ID)),)
            ...
            WLAN_IP_SET_1_SERIES := $(WLAN_6765_SERIES) 6833
            WLAN_IP_SET_2_SERIES := 3967 6785
            WLAN_IP_SET_3_SERIES := 6779 6885 6873 6853 6893 6877
