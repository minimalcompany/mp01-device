...
enum cmdq_event {
  ...
  CMDQ_EVENT_VENC_FRAME_DONE,
  CMDQ_EVENT_VENC_PAUSE_DONE,
  ...
  CMDQ_EVENT_IPE_EVENT_TX_FRAME_DONE_0,
  CMDQ_EVENT_IPE_EVENT_TX_FRAME_DONE_1,
  CMDQ_EVENT_IPE_EVENT_TX_FRAME_DONE_2,
  CMDQ_EVENT_IPE_EVENT_TX_FRAME_DONE_3,
