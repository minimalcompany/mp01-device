PRODUCT_COPY_FILES += device/mediatek/vendor/common/project_manifest/manifest_hwcomposer_2_1.xml:$(TARGET_COPY_OUT_VENDOR)/etc/vintf/manifest/manifest_hwcomposer.xml
