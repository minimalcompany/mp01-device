PRODUCT_COPY_FILES += device/mediatek/vendor/common/project_manifest/manifest_hwcomposer_2_4.xml:$(TARGET_COPY_OUT_VENDOR)/etc/vintf/manifest/manifest_hwcomposer.xml
PRODUCT_COPY_FILES += device/mediatek/vendor/common/project_hal_rc/android.hardware.graphics.composer@2.4-service.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/android.hardware.graphics.composer@2.4-service.rc
