...
FM_6632_CHIPS := 6632
FM_6635_CHIPS := 6873
FM_6631_6635_CHIPS := 6779 6781 6853 6833
FM_CONNAC2X_CHIPS := 6885 6893 6877
...
ifneq ($(FM_CHIP),)
    ...
    FM_PLAT := $(FM_CHIP)
    ifeq ($(strip $(FM_CONNAC2)), yes)
        FM_PLAT := connac2x
    endif
else
    FM_PLAT := mt6631_6635
    PRODUCT_PROPERTY_OVERRIDES += persist.vendor.connsys.fm_chipid=$(FM_PLAT)
endif

PRODUCT_PROPERTY_OVERRIDES += ro.vendor.fm.platform=$(FM_PLAT)
...
ifeq ($(ENABLE_KBUILD), false)
    PRODUCT_PACKAGES += fmradio_drv_$(FM_PLAT).ko
endif
...
PRODUCT_COPY_FILES += $(FM_CFG_PATH)/mt6631/mt6631_fm_v1_patch.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/mt6631_fm_v1_patch.bin:mtk
PRODUCT_COPY_FILES += $(FM_CFG_PATH)/mt6631/mt6631_fm_v1_coeff.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/mt6631_fm_v1_coeff.bin:mtk
PRODUCT_COPY_FILES += $(FM_CFG_PATH)/mt6635/mt6635_fm_v1_patch.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/mt6635_fm_v1_patch.bin:mtk
PRODUCT_COPY_FILES += $(FM_CFG_PATH)/mt6635/mt6635_fm_v1_coeff.bin:$(TARGET_COPY_OUT_VENDOR)/firmware/mt6635_fm_v1_coeff.bin:mtk
