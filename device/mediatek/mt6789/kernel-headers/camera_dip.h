...
#define DIP_GET_GCE_FIRST_ERR _IOWR(DIP_MAGIC, DIP_CMD_GET_GCE_FIRST_ERR, unsigned int)
#define DIP_SET_BUF_PA        _IOWR(DIP_MAGIC, DIP_CMD_SET_BUF_PA, struct DIP_ION_MEM_INFO)
#define DIP_DET_BUF_FD        _IOWR(DIP_MAGIC, DIP_CMD_DET_BUF_FD, unsigned int)
