...
typedef struct {
    long timeout;
    unsigned int hwpa;
} JPEG_DEC_DRV_HYBRID_IN;


typedef struct {
    long timeout;
    unsigned int *hwpa;
} JPEG_DEC_DRV_HYBRID_OUT;
...
#define JPEG_DEC_IOCTL_LOCK     _IOWR(JPEG_IOCTL_MAGIC, 18, JPEG_DEC_DRV_HYBRID_OUT)
#define JPEG_DEC_IOCTL_HYBRID_WAIT  _IOWR(JPEG_IOCTL_MAGIC, 19, JPEG_DEC_DRV_HYBRID_IN)
#define JPEG_DEC_IOCTL_UNLOCK   _IOWR(JPEG_IOCTL_MAGIC, 20, JPEG_DEC_DRV_HYBRID_IN)
