...
struct WPE_Config {
  ...
  unsigned int WPE_WPEO2_BASE_ADDR;
  unsigned int WPE_WPEO2_OFST_ADDR;
  unsigned int WPE_WPEO2_XSIZE;
  unsigned int WPE_WPEO2_YSIZE;
  unsigned int WPE_WPEO2_STRIDE;
  unsigned int WPE_WPEO2_CON;
  unsigned int WPE_WPEO2_CON2;
  unsigned int WPE_WPEO2_CON3;
  unsigned int WPE_WPEO2_CROP;
  ...
  unsigned int WPE_AFBC_RDMA_BASE_ADDR;
  unsigned int WPE_AFBC_CONTROL_Register;
  unsigned int WPE_WPEO_FMT;
...
#define WPE_SET_BUF_PA _IOWR(WPE_MAGIC, WPE_CMD_SET_BUF_PA, struct WPE_ION_MEM_INFO)
