...
enum MFB_CMD_ENUM {
  MFB_CMD_MSS_RESET,
  MFB_CMD_MSF_RESET,
  MFB_CMD_MSS_DUMP_REG,
  MFB_CMD_MSF_DUMP_REG,
  MFB_CMD_MSS_DUMP_ISR_LOG,
  MFB_CMD_MSF_DUMP_ISR_LOG,
  MFB_CMD_MSS_READ_REG,
  MFB_CMD_MSF_READ_REG,
  MFB_CMD_MSS_WRITE_REG,
  MFB_CMD_MSF_WRITE_REG,
  MFB_CMD_MSS_WAIT_IRQ,
  MFB_CMD_MSF_WAIT_IRQ,
  MFB_CMD_MSS_CLEAR_IRQ,
  MFB_CMD_MSF_CLEAR_IRQ,
  MFB_CMD_MSS_ENQUE_REQ,
  MFB_CMD_MSF_ENQUE_REQ,
  MFB_CMD_MSS_DEQUE_REQ,
  MFB_CMD_MSF_DEQUE_REQ,
  MFB_CMD_MAP,
  MFB_CMD_UNMAP,
  MFB_CMD_TOTAL,
};
...
#define MFB_MSS_READ_REGISTER _IOWR(MFB_MAGIC, MFB_CMD_MSS_READ_REG, struct MFB_REG_IO_STRUCT)
#define MFB_MSS_WRITE_REGISTER _IOWR(MFB_MAGIC, MFB_CMD_MSS_WRITE_REG, struct MFB_REG_IO_STRUCT)
#define MFB_MSS_WAIT_IRQ _IOW(MFB_MAGIC, MFB_CMD_MSS_WAIT_IRQ, struct MFB_WAIT_IRQ_STRUCT)
#define MFB_MSS_CLEAR_IRQ _IOW(MFB_MAGIC, MFB_CMD_MSS_CLEAR_IRQ, struct MFB_CLEAR_IRQ_STRUCT)
#define MFB_MSF_READ_REGISTER _IOWR(MFB_MAGIC, MFB_CMD_MSF_READ_REG, struct MFB_REG_IO_STRUCT)
#define MFB_MSF_WRITE_REGISTER _IOWR(MFB_MAGIC, MFB_CMD_MSF_WRITE_REG, struct MFB_REG_IO_STRUCT)
#define MFB_MSF_WAIT_IRQ _IOW(MFB_MAGIC, MFB_CMD_MSF_WAIT_IRQ, struct MFB_WAIT_IRQ_STRUCT)
#define MFB_MSF_CLEAR_IRQ _IOW(MFB_MAGIC, MFB_CMD_MSF_CLEAR_IRQ, struct MFB_CLEAR_IRQ_STRUCT)
#define MFB_MSS_ENQUE_REQ _IOWR(MFB_MAGIC, MFB_CMD_MSS_ENQUE_REQ, struct MFB_MSSRequest)
#define MFB_MSS_DEQUE_REQ _IOWR(MFB_MAGIC, MFB_CMD_MSS_DEQUE_REQ, struct MFB_MSSRequest)
#define MFB_MSF_ENQUE_REQ _IOWR(MFB_MAGIC, MFB_CMD_MSF_ENQUE_REQ, struct MFB_MSFRequest)
#define MFB_MSF_DEQUE_REQ _IOWR(MFB_MAGIC, MFB_CMD_MSF_DEQUE_REQ, struct MFB_MSFRequest)
#define MFB_MAP _IOWR(MFB_MAGIC, MFB_CMD_MAP, struct MFB_MapTable)
#define MFB_UNMAP _IOWR(MFB_MAGIC, MFB_CMD_UNMAP, struct MFB_MapTable)
#endif
